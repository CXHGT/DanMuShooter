...
void DanmaKuWebSocket::WebSocketClose()
{
    disconnect(this->websocket, &QWebSocket::connected, this, &DanmaKuWebSocket::WebSocketConnected);
    // 断开时触发
    disconnect(this->websocket, &QWebSocket::disconnected, this, &DanmaKuWebSocket::WebSocketDisconnected);
    // 接收到数据
    disconnect(this->websocket, &QWebSocket::binaryMessageReceived, this, &DanmaKuWebSocket::WebSocketReceived);
